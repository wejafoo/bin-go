...
func NewInstance(file string) FDC {
	...
	Pwd, _		= os.Getwd()
	Fdg			= FDC {
		false, false, false, false, false, "ng", "public",
	...
	if Fdc.FdTargetLocalPort	== 0  { Fdc.FdTargetLocalPort	= Fdg.FdTargetLocalPort	}
	...
	if Fdc.FdTargetRemotePort	== 0  { Fdc.FdTargetRemotePort	= Fdg.FdTargetRemotePort}
